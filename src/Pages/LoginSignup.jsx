...
const LoginSignup = () => {
  ...
  const login = async () => {
    ...
    await fetch('https://backend-lcua.onrender.com/login',{
      ...
      headers:{
        ...
        body: JSON.stringify(formData),}).then((response)=> response.json()).then((data)=>responseData=data)
  ...
  const signup = async () => {
    ...
    let responseData;
    await fetch('https://backend-lcua.onrender.com/signup',{
      method:'POST',
      headers:{
        Accept:'application/form-data',
        'Content-Type':'application/json',
    ...
    <div className="loginsignup">
      <div className="loginsignup-container">
        ...
        <div className="loginsignup-agree">
          ...
          <p>
            By Contributing, I agree to the terms of use & privacy policy
          </p>
        </div>
      </div>
    </div>
